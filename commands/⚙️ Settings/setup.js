...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    try {
      ...
      message.guild.channels.create("Sequen Music - Requests", {
          type: 'category',
                  ...
                  message.guild.channels.create(`🎵｜requests`, {
                    ...
                    .then(async (channel3) => {
                      let embed1 = new MessageEmbed()
                        ...
                        .setTitle("Sequen Music | Request | Guide")
                      ...
                      let embed2 = new MessageEmbed()
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle("Sequen Music | Music Queue")
                        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
                      let embed3 = new MessageEmbed()
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle("Sequen Music | Currently no song is playing!")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite Sequen Music](https://discord.com/oauth2/authorize?client_id=660449158599016457&scope=bot&permissions=8) • [Support Server](https://discord.gg/wfM2AmA6Vk)`)
